...
export const sections = [
  ...
  },
  {
    ...
    equipment: [
      ...
      { name: 'LGCE E6210H', type: 'Экскаватор', desc: 'Разработка грунта и расчистка территорий' },
      { name: 'МАЗ / КАМАЗ / УРАЛ', type: 'Лесовоз', desc: 'Транспортировка хлыстов и сортиментов на большие расстояния' },
    ]
  },
  {
    id: 'projects',
